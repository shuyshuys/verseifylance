...
if (isset($_GET['serviceID'])) {
    ...
    if ($hasil) {
        ...
        AlertMessage::displayAlert($success, "Payment Success!", "check-circle-fill");
    } else {
...
<head>
    ...
    <title>Cart | VerseifyLance</title>
    ...
    <!-- VerseifyLance Design System Css -->
                            ...
                            <li class="nav-item dropdown">
                                <a class="py-0 nav-link d-flex align-items-center" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                    ...
                                    <div class="caption ms-3 d-none d-md-block ">
                                        ...
                                        <p class="mb-0 caption-sub-title"><?php echo $_SESSION['user']['ROLE'] ?></p>
                                    </div>
                                </a>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <h4 class="mb-3">Hello, <?php echo $_SESSION['user']['FULL_NAME'] ?></h4>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-12 mt-4">
                                    ...
                                    ?>
                                        ...
                                        <h6 class="mb-3">Created at: <?php echo $orders[0]['CREATED_AT'] ?></h6> -->
                                            <table class="table  table-bordered">
                                                ...
                                                <!-- php perulangan dengan while untuk orders[] -->
                                                <tbody>
                                                    <?php
                                                    $totalBayar = 0;
                                                    $i = 0;
                                                    ...
                                                    <td class="text-center"></td>
                                                        ...
                                                        <td class="text-center"></td>
                                                        <td class="text-center"></td>
                                                        <td class="text-center"><b>Rp.<?php echo $totalBayar ?></b></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
                                    <?php
                                        ...
                                        // print bahwa anda tidak memiliki pesanan yang belum dibayar, dalam bahasa inggris
                                        echo "<h4 class='mb-3'>You don't have any unpaid orders.</h4>";
                                    }
                                    ?>
                                </div>
                            </div>
