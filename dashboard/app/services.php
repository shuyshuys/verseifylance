...
// query untuk menghapus service dan menerima dari get id service
if (isset($_GET['id_service'])) {
    ...
    if (!$result) {
        ...
        echo "<script>alert('Data berhasil dihapus.');window.location='services.php';</script>";
    }
}
?>
<!doctype html>
...
<head>
    ...
    <title>Services | VerseifyLance</title>
                ...
                <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="sub-nav collapse show" id="horizontal-menu" data-bs-parent="#sidebar-menu">
                            <li class="nav-item">
                                <a class="nav-link active" href="../../dashboard/app/services">
                                    <i class="icon">
            ...
            <div>
                <div class="row">
                    ...
                    $query = "SELECT s.ID_SERVICE, f.FULL_NAME, title, description, price, DATEDIFF(CURDATE(), s.CREATED_AT) AS dayago FROM services s
                        join freelancers f on f.ID_FREELANCER = s.ID_FREELANCER where s.ID_FREELANCER = "  . $freelancerID . ";";
