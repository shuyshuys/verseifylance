...
<head>
    ...
    <title>Add Service | VerseifyLance</title>
        ...
        <div class="sidebar-body pt-0 data-scrollbar">
            <div class="sidebar-list">
                ...
                <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" aria-current="page" href="../../dashboard/freelancer">
                            <i class="icon">
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="sub-nav collapse show" id="horizontal-menu" data-bs-parent="#sidebar-menu">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="../../dashboard/app/add-service">
                                    <i class="icon">
                                        <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                                <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                ...
                <div class="row">
                    <div class="col-sm-12 col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form method="post" action="addservice.php" onsubmit="return validateForm()">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="description" name="description" rows="3" placeholder="Enter description for service"></textarea>
                                    </div>
                                    <div class="form-group">
                                        <label class="form-label" for="price">Price</label>
                                        <div class="input-group mb-3">
                                            <span class="input-group-text" id="basic-addon1">Rp.</span>
                                            <input type="text" class="form-control" id="price" name="price" value="" placeholder="Enter price for service">
                                        </div>
                                    </div>
