...
<head>
    ...
    <title>Profile | VerseifyLance</title>
    ...
    <aside class="sidebar sidebar-default sidebar-white sidebar-base navs-rounded-all ">
        <div class="sidebar-header d-flex align-items-center justify-content-start">
            <a href="../../dashboard/index.html" class="navbar-brand">
                ...
                <h4 class="logo-title">
                    <h1><?php echo isset($_SESSION['user']['username']) && !empty($_SESSION['user']['username']) ? "Welcome, " . $_SESSION['user']['username'] : "Please log in to access this page." ?>
                    </h1>
                </h4>
            </a>
                        ...
                        <div class="card-body">
                            <div class="d-grid gap-card grid-cols-3">
                                ...
                                <a data-fslightbox="gallery" href="../../assets/images/shapes/02.png">
                                    <img src="../../assets/images/shapes/02.png"
                                        class="img-fluid bg-soft-primary rounded" alt="profile-image">
                                </a>
                                ...
                                <a data-fslightbox="gallery" href="../../assets/images/shapes/04.png">
                                    <img src="../../assets/images/shapes/04.png"
                                        class="img-fluid bg-soft-primary rounded" alt="profile-image">
                                </a>
                                <a data-fslightbox="gallery" href="../../assets/images/icons/02.png">
                                    <img src="../../assets/images/icons/02.png"
                                        class="img-fluid bg-soft-warning rounded" alt="profile-image">
                                </a>
                                <a data-fslightbox="gallery" href="../../assets/images/shapes/06.png">
                                    <img src="../../assets/images/shapes/06.png"
                                        class="img-fluid bg-soft-primary rounded" alt="profile-image">
                                </a>
                                ...
                                <a data-fslightbox="gallery" href="../../assets/images/icons/01.png">
                                    <img src="../../assets/images/icons/01.png"
                                        class="img-fluid bg-soft-success rounded" alt="profile-image">
                                </a>
                            </div>
                        </div>
                    </div>
                                                ...
                                                <div class="d-flex">
                                                    ...
                                                    <div class="ms-3">
                                                        ...
                                                        <div class="d-flex flex-wrap align-items-center mb-1">
                                                            ...
                                                            <a href="javascript:void(0);" class="me-3">
                                                                <svg width="20" class="me-1 icon-20"
                                                                    viewBox="0 0 24 24">
                                                                    <path fill="currentColor"
