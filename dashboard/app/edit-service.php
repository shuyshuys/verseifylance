...
<head>
    ...
    <title>Edit Service | VerseifyLance</title>
...
<body class="  ">
                    ...
                    <div class="col-sm-12 col-lg-12">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between">
                                <div class="header-title">
                                    <h4 class="card-title">Register a new service</h4>
                                </div>
                            </div>
                            <div class="card-body">
                                <form method="post" action="updateservice.php">
                                    <?php
                                    $query = "select TITLE, DESCRIPTION, PRICE from services s where ID_SERVICE = " . $serviceID . " and ID_FREELANCER = " . $freelancerID . ";";
                                    $result = mysqli_query($koneksi, $query);
                                    $row = mysqli_fetch_array($result);
                                    ?>
                                    <div class="form-group">
                                        <label class="form-label" for="name">Name of Service</label>
                                        <input type="text" class="form-control" id="name" name="name" placeholder="Enter service name" value="<?php echo $row['TITLE'] ?>">
                                        <input type="hidden" name="id" value="<?php echo $serviceID; ?>">
                                    </div>
                                    <div class="form-group">
                                        <label class="form-label" for="description">Description</label>
                                        <textarea class="form-control" id="description" name="description" rows="3" placeholder="Enter description for service" ><?php echo $row['DESCRIPTION'] ?></textarea>
                                    </div>
                                    <div class="form-group">
                                        <label class="form-label" for="price">Price</label>
                                        <div class="input-group mb-3">
                                            <span class="input-group-text" id="basic-addon1">Rp.</span>
                                            <input type="text" class="form-control" id="price" name="price" value="<?php echo $row['PRICE'] ?>" placeholder="Enter price for service">
                                        </div>
                                    </div>
                                    <button type="submit" class="btn btn-primary" name="submit">Edit</button>
                                    <button type="" class="btn btn-info"><a href="./services" style="text-decoration: none; color:inherit;">Back</a></button>
    ...
    <script>
        function validateForm() {
            ...
            // Jika validasi berhasil, hapus pesan peringatan
