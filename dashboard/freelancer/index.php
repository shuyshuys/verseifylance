...
JOIN services s ON s.ID_SERVICE = o.ID_SERVICE
JOIN freelancers f ON f.ID_FREELANCER = s.ID_FREELANCER
WHERE f.ID_FREELANCER = '1201' and o.CREATED_AT = CURDATE();";
$result = mysqli_query($koneksi, $query);
$todayIncome = mysqli_fetch_assoc($result)['TOTAL_AMOUNT'];
// $number = $todayIncome;
...
<head>
    ...
    <title>Freelancer Dashboard | VerseifyLance</title>
...
<body class="  ">
                        ...
                        <ul class="sub-nav collapse" id="utilities-error" data-bs-parent="#sidebar-menu">
                            <li class="nav-item">
                                <a class="nav-link " href="../../reportpdf-freelancer.php?freelancerid=<?php echo $freelancerID?>">
                                    ...
                                    <span class="item-name">Download PDF</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link " href="../../reportexcel?freelancerid=<?php echo $freelancerID?>">
                                    ...
                                    <span class="item-name">Download Excel</span>
                                </a>
                            </li>
                        </ul>
                    </li>
                        ...
                        <ul class="mb-2 navbar-nav ms-auto align-items-center navbar-list mb-lg-0">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                    ...
                                    <li><a class="dropdown-item" href="../../pages/auth/logout">Logout</a></li>
                                </ul>
                            </li>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="flex-wrap d-flex justify-content-between align-items-center">
                                <div>
                                    <h1>Hello <?php echo $freelancerName ?>!</h1>
                                ...
                                <li class="swiper-slide card card-slide" data-aos="fade-up" data-aos-delay="700">
                                    <div class="card-body">
                                        <div class="progress-widget">
                                            <div id="circle-progress-01" class="text-center circle-progress-01 circle-progress circle-progress-primary" data-min-value="0" data-max-value="100" data-value="50" data-type="percent">
                                    ...
                                    <div class="card-body">
                                        <div class="progress-widget">
                                            ...
                                            <div class="progress-detail">
                                                ...
                                                <h4 class="counter"><?php echo $services ?> Service</h4>
                                            </div>
                                        </div>
                                    </div>
                                </li>
                                    ...
                                    <div class="card-body">
                                        <div class="progress-widget">
                                            ...
                                            <div class="progress-detail">
                                                ...
                                                <h4 class="counter">Rp<?php echo $todayIncome ?></h4>
                                            </div>
                                        </div>
                                    </div>
                                </li>
                            ...
                            <div class="overflow-hidden card" data-aos="fade-up" data-aos-delay="600">
                                <div class="flex-wrap card-header d-flex justify-content-between">
                                    <div class="header-title">
                                        ...
                                        <p class="mb-0">
                                            ...
                                            <!-- ambil data dengan php dari query sebelumnya -->
                                            <?php
                                            while ($row = mysqli_fetch_array($result)) {
                                            ?>
                                                <span class="text-primary"><?php echo $row[0]; ?></span> new acquired this
                                                month
                                            <?php
                                            }
                                            ?>
                                ...
                                <div class="p-0 card-body">
                                    <div class="mt-4 table-responsive">
                                        <?php
                                        $query = "SELECT u.USERNAME, c.FULL_NAME , COUNT(u.USERNAME) AS REPEAT_ORDER, SUM(p.TOTAL_AMOUNT) AS TOTAL_AMOUNT 
                                        FROM users u 
                                        JOIN customers c ON c.ID_USER = u.ID_USER 
                                        JOIN orders o ON o.ID_CUSTOMER = c.ID_CUSTOMER LEFT JOIN payments p ON p.ID_PAYMENT = o.ID_PAYMENT 
                                        JOIN services s ON s.ID_SERVICE = o.ID_SERVICE
                                        WHERE s.ID_FREELANCER = '$freelancerID' AND o.STATUS = 1
                                        GROUP BY u.USERNAME; ";
                                        $result = mysqli_query($koneksi, $query);
                                        ?>
                                        <table id="basic-table" class="table mb-0 table-striped" role="grid">
                                            ...
                                            <tbody>
                                                ...
                                                while ($row = mysqli_fetch_array($result)) {
                                                    ...
                                                    $words = explode(' ', $username); // Memisahkan kata-kata dalam string menjadi array

                                                    $initials = '';
                                                    foreach ($words as $word) {
                                                        $initials .= strtoupper(substr($word, 0, 1)); // Mengambil satu huruf pertama dari setiap kata dan menggabungkannya
                                                    }
                                                ?>
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <img class="rounded bg-soft-primary img-fluid avatar-40 me-3" src="../../assets/images/shapes/0<?php echo $i ?>.png" alt="profile">
                                                                <h6><?php echo $row['FULL_NAME']; ?></h6>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div class="iq-media-group iq-media-group-1">
                                                                <!-- lakukan perulangan sejumlah $row['REPEAT_ORDER'] -->
                                                                <?php
                                                                for ($j = 0; $j < $row['REPEAT_ORDER']; $j++) {
                                                                ?>
                                                        ...
                                                        <!-- <td>
                                                            ...
                                                            <div class="shadow-none progress bg-soft-primary w-100" style="height: 6px;">
                                    ...
                                    var myChart = new Chart(ctx, {
                                        ...
                                        data: {
                                            ...
                                            datasets: [{
                                                ...
                                                backgroundColor: 'rgba(174, 134, 255, 0.2)',
                                                borderColor: 'rgba(174, 134, 255, 1)',
                                                borderWidth: 1
                                            }]
                                        },
                                        options: {
                        ...
                        <div class="col-md-12">
                            <div class="card" data-aos="fade-up" data-aos-delay="800">
                                <div class="flex-wrap card-header d-flex justify-content-between align-items-center">
                                    ...
                                    <!-- <div class="d-flex align-items-center align-self-center">
                                        <div class="d-flex align-items-center text-primary">
                                            ...
                                            <div class="ms-2">
                                                <span class="text-gray">Service</span>
                                            </div>
                                        </div>
                                        <div class="d-flex align-items-center ms-3 text-info">
                                            <svg class="icon-12" xmlns="http://www.w3.org/2000/svg" width="12" viewBox="0 0 24 24" fill="currentColor">
                                ...
                                <script>
                                    ...
                                    // Ambil elemen dropdown dan daftar item dropdown
                                    ...
                                    dropdownItems.forEach(item => {
                                        item.addEventListener('click', function(event) {
                                            ...
                                            // Dapatkan nilai data-value dari item yang dipilih
                                            const selectedValue = item.getAttribute('data-value');
                                            console.log(selectedValue);

                                            // Panggil fungsi untuk memperbarui tampilan berdasarkan pilihan
                                    ...
                                    function updateChart(selectedValue) {
                                        // Buat query sesuai dengan pilihan dropdown
                                        let query;
                                        if (selectedValue === 'earning') {
                                            query = "select MONTHNAME(o.created_at) as MONTH, SUM(p.TOTAL_AMOUNT) as TOTAL_AMOUNT, c.FULL_NAME from orders o join payments p on p.ID_PAYMENT = o.ID_PAYMENT join customers c on c.ID_CUSTOMER = o.ID_CUSTOMER where p.STATUS = 1 group by month(o.CREATED_AT);";
                                            ...
                                            query = "select s.TITLE, sum(TOTAL_AMOUNT) as TOTAL_AMOUNT from orders o join services s on s.ID_SERVICE = o.ID_SERVICE join payments p on p.ID_PAYMENT = o.ID_PAYMENT group by s.TITLE;";
                                        }
                                        ...
                                        $.ajax({
                                            ...
                                            success: function(response) {
                                                // Tangani respon dari skrip PHP
                                                // Misalnya, tampilkan chart berdasarkan data yang diterima
                                        ...
                                        function displayChart(data) {
                                            // Mendapatkan elemen canvas chart
                                            var ctx = document.getElementById('barChart').getContext('2d');

                                            // Membuat chart menggunakan data yang diterima
                                            var myChart = new Chart(ctx, {
                                                type: 'bar',
                                                data: {
                    ...
                    <div class="row">
                        <div class="col-md-12 col-lg-12">
                            ...
                            <div class="card" data-aos="fade-up" data-aos-delay="500">
                                <div class="text-center card-body d-flex justify-content-around">
                                    ...
                                    <hr class="hr-vertial">
                                    <div>
                                        <h2 class="mb-2"><?php echo $monthlyCustomer ?></h2>
                                        <p class="mb-0 text-gray">Monthly Customer</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12 col-lg-12">
                            <div class="card" data-aos="fade-up" data-aos-delay="600">
                                ...
                                <div class="card-body">
                                    <?php
                                    $query = "select o.ID_ORDER, DATE_FORMAT(o.CREATED_AT, '%d %M %Y') AS DATE from orders o  
                                    ...
                                    ?>
                                        <div class="mb-2  d-flex profile-media align-items-top">
                                            ...
                                            <div class="ms-4">
                                                <h6 class="mb-1 ">New order #<?php echo $row['ID_ORDER']; ?></h6>
                                                <span class="mb-0"><?php echo $row['DATE']; ?></span>
                                            </div>
                                        </div>
                                    <?php
                                    }
    ...
    <!-- <script>
        var months = <?php // echo json_encode($months); 
                        ?>;
        var totals = <?php // echo json_encode($totalAmounts); 
                        ?>;
        var fullNames = <?php // echo json_encode($fullNames); 
                        ?>;
        // console.log(months);
        // console.log(totals);
