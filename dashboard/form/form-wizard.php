...
<head>
    ...
    <title>Complete Registration Freelancer | VerseifyLance</title>
                        ...
                        <ul class="mb-2 navbar-nav ms-auto align-items-center navbar-list mb-lg-0">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                    ...
                                    <li><a class="dropdown-item" href="../../pages/auth/logout">Logout</a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
                    ...
                    <div class="col-sm-12 col-lg-12">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between">
                                <div class="header-title">
                                    <h4 class="card-title">Complete Wizard First</h4>
                                </div>
                            </div>
                            <div class="card-body">
                                <form class="mt-3 text-center" method="post" action="wizard.php" enctype="multipart/form-data">
                                    <!-- fieldsets -->
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="email" class="form-control" name="email" placeholder="Email Id" value="<?php echo $hasiluser['EMAIL'] ?>" readonly />
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="form-label">Username: </label>
                                                    <input type="text" class="form-control" name="uname" placeholder="UserName" value="<?php echo $hasiluser['USERNAME'] ?>" readonly />
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="form-label">Role: </label>
                                                    <input type="text" class="form-control" name="role" placeholder="Role" value="<?php echo $hasiluser['ROLE'] ?>" readonly />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="fname" placeholder="Full Name" value="<?php echo $hasiluser['FULL_NAME'] ?>" readonly />
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="mb-3 form-check" id="targetNewLine">
                                                        <?php
                                                        echo "<pre>";
                                                        // print_r($skills);
                                                        echo "</pre>";
                                                        foreach ($skills as $skill) {
                                                            ...
                                                            $skillName = $skill[1];
                                                        ?>
                                                            <input type="checkbox" class="form-check-input" id="skill<?php echo $skillId; ?>" name="skills[]" value="<?php echo $skillId; ?>">
                                                            <label class="form-check-label" for="skill<?php echo $skillId; ?>"><?php echo $skillName; ?></label><br>
                                                        <?php
                                                        }
                                                        ?>
                                                    </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="form-label">Portofolio URL: *</label>
                                                    <input type="text" class="form-control" name="portofolio" placeholder="Porofolio URL" />
                                                </div>
                                            </div>

                                            <div class="col-md-6">
                                                <!-- Additional Checkbox for New Skill -->
                                                <div class="mb-3 form-check">
                                                    <input type="checkbox" class="form-check-input" id="newSkillCheckbox" name="skills[]" value="newSkill">
                                                    <label class="mb-2 form-check-label" for="newSkillCheckbox">Add
                                                        New Skill</label>
                                                    <div id="newSkillInputContainer" style="display: none;">
                                                        <div class="input-group mr-2">
                                                            <input type="text" class="form-control" id="newSkillInput" name="newSkill" placeholder="Enter New Skill">
                                                            <button type="button" id="addNewSkillButton" class="btn btn-primary">Add</button>
                                                        </div>
                                                    </div>
                                                </div>

                                                <script>
                                                    // Show/hide the new skill input field based on the newSkillCheckbox state
                                                    const newSkillCheckbox = document.getElementById(
                                                        'newSkillCheckbox');
                                                    const newSkillInputContainer = document.getElementById(
                                                        'newSkillInputContainer');
                                                    const addNewSkillButton = document.getElementById(
                                                        'addNewSkillButton');

                                                    newSkillCheckbox.addEventListener('change', function() {
                                                        if (newSkillCheckbox.checked) {
                                                            newSkillInputContainer.style.display =
                                                                'block';
                                                        } else {
                                                            newSkillInputContainer.style.display =
                                                                'none';
                                                    ...
                                                    addNewSkillButton.addEventListener('click', function() {
                                                        const newSkillInput = document.getElementById(
                                                            'newSkillInput');
                                                        const newSkill = newSkillInput.value.trim();

                                                        if (newSkill !== '') {
                                                            // Send an AJAX request to add the new skill to the database
                                                            const xhr = new XMLHttpRequest();
                                                            xhr.open('POST', 'add_skill.php');
                                                            xhr.setRequestHeader('Content-Type',
                                                                'application/x-www-form-urlencoded');
                                                            xhr.onload = function() {
                                                                if (xhr.status === 200) {
                                                                    // Retrieve the newly added skill ID from the response
                                                                    const newSkillId = xhr
                                                                        .responseText;

                                                                    // Create the new skill checkbox
                                                                    const newSkillCheckbox = document
                                                                        .createElement('input');
                                                                    newSkillCheckbox.type = 'checkbox';
                                                                    newSkillCheckbox.className =
                                                                        'form-check-input';
                                                                    newSkillCheckbox.id = 'skill' +
                                                                        newSkillId;
                                                                    newSkillCheckbox.name = 'skills[]';
                                                                    newSkillCheckbox.value = newSkillId;

                                                                    // Create the new skill label
                                                                    const newSkillLabel = document
                                                                        .createElement('label');
                                                                    newSkillLabel.className =
                                                                        'form-check-label';
                                                                    newSkillLabel.htmlFor = 'skill' +
                                                                        newSkillId;
                                                                    newSkillLabel.textContent = newSkill;

                                                                    // Append the new checkbox and label to the targetNewLine element
                                                                    const targetNewLine = document
                                                                        .getElementById('targetNewLine');
                                                                    targetNewLine.appendChild(
                                                                        newSkillCheckbox);
                                                                    targetNewLine.appendChild(
                                                                        newSkillLabel);
                                                                    targetNewLine.appendChild(document
                                                                        .createElement('br'));
                                                            ...
                                                            xhr.send('newSkill=' + encodeURIComponent(
                                                                newSkill));
                                                        }
                                                    });
                                                </script>
                                    ...
                                    <!-- <fieldset>
                                    <button type="button" name="submit" class="btn btn-primary next action-button float-end" value="submit">Submit</button>
                                    <button type="button" name="previous" class="btn btn-dark previous action-button-previous float-end me-1" value="Previous">Previous</button>
                                </fieldset> -->
                                <button type="submit" id="submit" name="submit" value="submit" class="btn btn-primary next action-button float-end">Submit</button>
                                    <!-- <fieldset>
                                        <div class="form-card">
                                            <div class="row">
                                                <div class="col-7">
